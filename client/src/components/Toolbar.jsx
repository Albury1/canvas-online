...
import FilledCircle from "../tools/FilledCircle"
import EmptyRect from "../tools/EmptyRect"
...
const Toolbar = () => {
    ...
    return (
        <div className="toolbar">
            ...
            <button className="toolbar__btn empty-rect" onClick={() => toolState.setTool(new EmptyRect(canvasState.canvas))} />
            <button className="toolbar__btn filled-circle" onClick={() => toolState.setTool(new FilledCircle(canvasState.canvas))} />
